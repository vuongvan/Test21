...
class SettingsFragment(
    ...
    override fun onCreateView(inflater: android.view.LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val edit = EditText(ctx).apply {
            ...
            setText(sharedPref.getString(ExampleProvider.PREF_DOMAIN, ExampleProvider().mainUrl))
        ...
        val saveBtn = Button(ctx).apply {
            ...
            setOnClickListener {
                ...
                sharedPref.edit().putString(ExampleProvider.PREF_DOMAIN, domain).apply()
                showToast("Saved")
        ...
        val resetBtn = Button(ctx).apply {
            text = "Reset"
            setOnClickListener {
                sharedPref.edit().remove(ExampleProvider.PREF_DOMAIN).apply()
                edit.setText(ExampleProvider().mainUrl)
                showToast("Reset")
                AlertDialog.Builder(ctx)
